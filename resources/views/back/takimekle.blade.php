...
@section('title','Takım Ekle')        <!-- Content Wrapper -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="content col-lg-10" style="background:#fff;border-style: solid;">
                        ...
                        @endif
                       <form action="{{route('admin.takimpost.ekle')}}" method="post" enctype="multipart/form-data" style="margin-top:20px;">
                        @csrf
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" value="{{old('job')}}" class="form-control" name="job"  >
