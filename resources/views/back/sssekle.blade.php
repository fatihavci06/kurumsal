...
@section('title','SSS Güncelle')        <!-- Content Wrapper -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="content col-lg-10" style="background:#fff;border-style: solid;">
                        ...
                        @endif
                       <form action="{{route('admin.sss.ekle')}}" method="post" enctype="multipart/form-data" style="margin-top:20px;">
                        @csrf
                          <div class="form-group">
                            <label for="exampleInputEmail1">Soru</label>
                            <input type="text" value="{{old('soru')}}" class="form-control" name="soru"  >
                            
                          </div>
                          <div class="form-group">
                            <label for="exampleInputEmail1">Cevap</label>
                            <input type="text" value="{{old('cevap')}}" class="form-control" name="cevap"  >
