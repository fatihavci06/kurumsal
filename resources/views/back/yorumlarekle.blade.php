...
@section('title','Hizmet Ekle')        <!-- Content Wrapper -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="content col-lg-10" style="background:#fff;border-style: solid;">
                        ...
                        @endif
                       <form action="{{route('admin.yorumlarpost.ekle')}}" method="post" enctype="multipart/form-data" style="margin-top:20px;">
                        @csrf
                          <div class="form-group">
                            <label for="exampleInputEmail1">İsim</label>
                            <input type="text" value="{{old('name')}}" class="form-control" name="name"  placeholder="Başlık">
                            
                          </div>
                          <div class="form-group">
                            <label for="exampleInputEmail1">Meslek</label>
                            <input type="text" value="{{old('job')}}" class="form-control" name="job"  placeholder="Başlık">
                          ...
                          <div class="form-group">
                            ...
                            <textarea id="summernote" style="background: #fff;" name="comment">{{old('comment')}}</textarea>
                          </div>
